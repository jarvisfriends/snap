...
Scope: snap (a Bubble Tea v2 component library ("snaps") for building terminal UIs) and its released artifacts
(per-example demo binaries (one archive per example)).
