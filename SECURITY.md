...
Please use
[GitHub's private vulnerability reporting](https://github.com/jarvisfriends/snap/security)
...
- We publish an advisory through
  [GitHub Security Advisories](https://github.com/jarvisfriends/snap/security) when the fix
